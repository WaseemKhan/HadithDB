...
News</a></li>
  ...
  <tr>
    ...
    <td width="667" valign="top">
      ...
      <div class="content"><em> <a href="mmtintro.php"> Translation of Malik's Muwatta, Book 34: </a> </em>
        <h1> <em> Renting Land </em> </h1>
        ...
        <hr>
        <h3> Section: Renting Land </h3>
        <hr>
        <em> <a name="034.34.1.1"> Book 34, Number 34.1.1: </a> </em>
        <!--BeginHadithBody-->
        <blockquote>
          <p> Yahya related to me from Malik from Rabia ibn Abd ar-Rahman from Handhala ibn Qays az-Zuraqi from Rafi ibn Khadij that the Messenger of Allah, may Allah bless him and grant him peace, forbade renting out fields. </p>
          <p> Handhala said, "I asked Rafi ibn Khadij, about paying in gold and silver, and he said, 'There is no harm in it.' " </p>
        </blockquote>
        <!--EndHadithBody-->
        <hr>
        <em> <a name="034.34.1.2"> Book 34, Number 34.1.2: </a> </em>
        <!--BeginHadithBody-->
        <blockquote>
          <p> Malik related to me that Ibn Shihab said, "I asked Said ibn al-Musayyab about renting land for gold or silver, and he said, 'There is no harm in it.' " </p>
        </blockquote>
        <!--EndHadithBody-->
        <hr>
        <em> <a name="034.34.1.3"> Book 34, Number 34.1.3: </a> </em>
        <!--BeginHadithBody-->
        <blockquote>
          <p> Malik related to me from Ibn Shihab that he asked Salim ibn 'Abdullah ibn Umar about renting out fields. He said, "There is no harm in it for gold or silver." Ibn Shihab said, "I said to him, 'What do you think of the hadith which is mentioned from Rafi ibn Khadij?'" He said, ''Rafi has exaggerated. If I had a field, I would rent it out." </p>
        </blockquote>
        <!--EndHadithBody-->
        <hr>
        <em> <a name="034.34.1.41"> Book 34, Number 34.1.41: </a> </em>
        <!--BeginHadithBody-->
        <blockquote>
          <p> Malik related to me that he had heard that Abd ar-Rahman ibn Awf rented land, and he continued to have it in his possession until he died. His son said, "I thought that it was ours because of the length of time which it had remained in his hands, until he mentioned it to us at his death. He ordered us to pay some rent which he owed in gold or silver." </p>
        </blockquote>
        <!--EndHadithBody-->
        <hr>
        <em> <a name="034.34.1.5"> Book 34, Number 34.1.5: </a> </em>
        <!--BeginHadithBody-->
        <blockquote>
          <p> Malik related to me from Hisham ibn Urwa that his father used to rent out his land for gold and silver. </p>
          <p> Malik was asked about a man who rented his field for 100 sa of dates or part of its produce of wheat or from other than its produce. He disapproved of that. </p>
        </blockquote>
        <!--EndHadithBody-->
